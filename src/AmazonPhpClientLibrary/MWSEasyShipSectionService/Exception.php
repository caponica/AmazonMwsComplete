...
/**
 * MWS Easy Ship Section Service Exception provides details of errors
 * returned by MWS Easy Ship Section Service service
 *
 */
class MWSEasyShipSectionService_Exception extends Exception

{
    ...
    /**
     * Constructs MWSEasyShipSectionService_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof MWSEasyShipSectionService_Exception) {
