 ...
 * sample for Get Scheduled Package Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSEasyShipSectionService_Model_GetScheduledPackage
 $request = new MWSEasyShipSectionService_Model_GetScheduledPackageRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeGetScheduledPackage($service, $request);

/**
  * Get Get Scheduled Package Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param MWSEasyShipSectionService_Interface $service instance of MWSEasyShipSectionService_Interface
  * @param mixed $request MWSEasyShipSectionService_Model_GetScheduledPackage or array of parameters
  */

  function invokeGetScheduledPackage(MWSEasyShipSectionService_Interface $service, $request)
  {
      try {
        $response = $service->GetScheduledPackage($request);
