...
/**
 * Update Scheduled Packages Sample
 */
 ...
 * sample for Update Scheduled Packages Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSEasyShipSectionService_Model_UpdateScheduledPackages
 $request = new MWSEasyShipSectionService_Model_UpdateScheduledPackagesRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeUpdateScheduledPackages($service, $request);

/**
  * Get Update Scheduled Packages Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param MWSEasyShipSectionService_Interface $service instance of MWSEasyShipSectionService_Interface
  * @param mixed $request MWSEasyShipSectionService_Model_UpdateScheduledPackages or array of parameters
  */

  function invokeUpdateScheduledPackages(MWSEasyShipSectionService_Interface $service, $request)
  {
      try {
        $response = $service->UpdateScheduledPackages($request);
