 ...
 * sample for List Pickup Slots Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSEasyShipSectionService_Model_ListPickupSlots
 $request = new MWSEasyShipSectionService_Model_ListPickupSlotsRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeListPickupSlots($service, $request);

/**
  * Get List Pickup Slots Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param MWSEasyShipSectionService_Interface $service instance of MWSEasyShipSectionService_Interface
  * @param mixed $request MWSEasyShipSectionService_Model_ListPickupSlots or array of parameters
  */

  function invokeListPickupSlots(MWSEasyShipSectionService_Interface $service, $request)
  {
      try {
        $response = $service->ListPickupSlots($request);
