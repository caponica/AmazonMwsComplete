...
/**
 * MWSEasyShipSectionService_Model_GetServiceStatusResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetServiceStatusResult: MWSEasyShipSectionService_Model_GetServiceStatusResult</li>
 ...
 */
 ...
 class MWSEasyShipSectionService_Model_GetServiceStatusResponse extends MWSEasyShipSectionService_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetServiceStatusResult' => array('FieldValue' => null, 'FieldType' => 'MWSEasyShipSectionService_Model_GetServiceStatusResult'),
     ...
     *
     * @param MWSEasyShipSectionService_Model_GetServiceStatusResult getServiceStatusResult
    ...
    /**
     * Construct MWSEasyShipSectionService_Model_GetServiceStatusResponse from XML string
     * 
     * @param $xml
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new MWSEasyShipSectionService_Model_GetServiceStatusResponse(($response->item(0))); 
        } else {
            throw new Exception ("Unable to construct MWSEasyShipSectionService_Model_GetServiceStatusResponse from provided XML. 
    ...
    {
        $xml = "";
        $xml .= "<GetServiceStatusResponse xmlns=\"https://mws.amazonservices.com/EasyShip/2018-09-01\">";
