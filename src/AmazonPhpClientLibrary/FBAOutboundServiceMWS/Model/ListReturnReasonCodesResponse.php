 ...
 */
 ...
 class FBAOutboundServiceMWS_Model_ListReturnReasonCodesResponse extends FBAOutboundServiceMWS_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'ListReturnReasonCodesResult' => array('FieldValue' => null, 'FieldType' => 'FBAOutboundServiceMWS_Model_ListReturnReasonCodesResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FBAOutboundServiceMWS_Model_ListReturnReasonCodesResponse(($response->item(0))); 
        } else {
