 ...
 */
 ...
 class FBAOutboundServiceMWS_Model_CreateFulfillmentReturnResponse extends FBAOutboundServiceMWS_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'CreateFulfillmentReturnResult' => array('FieldValue' => null, 'FieldType' => 'FBAOutboundServiceMWS_Model_CreateFulfillmentReturnResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FBAOutboundServiceMWS_Model_CreateFulfillmentReturnResponse(($response->item(0))); 
        } else {
