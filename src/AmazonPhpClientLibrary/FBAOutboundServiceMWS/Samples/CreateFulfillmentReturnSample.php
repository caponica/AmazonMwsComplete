...
/**
 * Create Fulfillment Return Sample
 */
 ...
 * sample for Create Fulfillment Return Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as FBAOutboundServiceMWS_Model_CreateFulfillmentReturn
 $request = new FBAOutboundServiceMWS_Model_CreateFulfillmentReturnRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeCreateFulfillmentReturn($service, $request);

/**
  * Get Create Fulfillment Return Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param FBAOutboundServiceMWS_Interface $service instance of FBAOutboundServiceMWS_Interface
  * @param mixed $request FBAOutboundServiceMWS_Model_CreateFulfillmentReturn or array of parameters
  */

  function invokeCreateFulfillmentReturn(FBAOutboundServiceMWS_Interface $service, $request)
  {
      try {
        $response = $service->CreateFulfillmentReturn($request);
