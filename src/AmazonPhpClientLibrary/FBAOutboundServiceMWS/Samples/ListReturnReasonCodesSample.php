...
/**
 * List Return Reason Codes Sample
 */
 ...
 * sample for List Return Reason Codes Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as FBAOutboundServiceMWS_Model_ListReturnReasonCodes
 $request = new FBAOutboundServiceMWS_Model_ListReturnReasonCodesRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeListReturnReasonCodes($service, $request);

/**
  * Get List Return Reason Codes Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param FBAOutboundServiceMWS_Interface $service instance of FBAOutboundServiceMWS_Interface
  * @param mixed $request FBAOutboundServiceMWS_Model_ListReturnReasonCodes or array of parameters
  */

  function invokeListReturnReasonCodes(FBAOutboundServiceMWS_Interface $service, $request)
  {
      try {
        $response = $service->ListReturnReasonCodes($request);
