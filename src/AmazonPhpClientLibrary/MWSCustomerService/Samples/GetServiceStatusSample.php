 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSCustomerService_Model_GetServiceStatus
 $request = new MWSCustomerService_Model_GetServiceStatusRequest();
...
/**
  ...
  * @param mixed $request MWSCustomerService_Model_GetServiceStatus or array of parameters
  */

  function invokeGetServiceStatus(MWSCustomerService_Interface $service, $request)
  {
      try {
