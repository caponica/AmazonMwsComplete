...
/**
 * MWS Cart Service Exception provides details of errors
 * returned by MWS Cart Service service
 *
 */
class MWSCartService_Exception extends Exception

{
    ...
    /**
     * Constructs MWSCartService_Exception
    ...
    public function __construct(array $errorInfo = array())
    {
        ...
        if (array_key_exists("Exception", $errorInfo)) {
            ...
            if ($exception instanceof MWSCartService_Exception) {
